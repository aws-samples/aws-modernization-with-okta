...
Passez à l'onglet "Groups", sélectionnez "AWS ViewOnlyAccess" et cliquez sur "Next". Les deux groupes affichés sont ceux que nous avons provisionnés depuis Okta à AWS SSO.
